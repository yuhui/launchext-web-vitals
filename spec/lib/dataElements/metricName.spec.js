...
describe('metricName data element delegate', () => {
  const dataElementDelegate = require('../../../src/lib/dataElements/metricName');
  ...
  describe('with invalid "event" argument', () => {
    ...
    it(
      'should be undefined when "name" property is missing',
      () => {
