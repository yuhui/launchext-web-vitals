...
describe('metricValue data element delegate', () => {
  const dataElementDelegate = require('../../../src/lib/dataElements/metricValue');
  ...
  describe('with invalid "event" argument', () => {
    ...
    it(
      'should be undefined when "value" property is missing',
      () => {
